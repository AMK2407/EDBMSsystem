...
public class JDBC_connection {
    public static void main (String []args){
        try{
            ...
            smt.executeUpdate("create table Emp(eno number primary key, ename varchar(40),  gender varchar(1), DOB varchar(11), Department varchar(20) )");
            ...
            smt.executeUpdate("create table ProjectDets(eno number(5), Proj_ID number(3), Proj_Name varchar(20), client varchar(7), commencementDate date, Status varchar(7))");
